...
switch ($action) {
    ...
    case 'valider' :
        ...
        Nous avons bien re�u l'inscription de votre classe pour la
        saison spectacles jeune public.<br>
        Nous vous remercions pour votre contribution
        et esp�rons vivement pouvoir vous donner enti�re satisfaction.<br>
        Val�rie Martin reste � votre disposition pour tout compl�ment d'information.
        N'h�sitez pas � la contacter, par mail de pr�f�rence � v.martin@kiosque-mayenne.org
        ou par t�l�phone au 02 43 30 10 16.<br>Voici le r�capitulatif de votre demande : <br>
        ...
        Civilit� : ".$_SESSION['enseignant']->getCivilite()."<br>Nom : ".$_SESSION['enseignant']->getNom()."<br>Pr�nom : ".$_SESSION['enseignant']->getPrenom()."<br>Facture libell�e � : ".$_SESSION['facture']."<br>
        <br><strong>Divers</strong> : <br>".$_SESSION['divers']."<br><br><strong>Enseignant</strong> : <br>
        Civilit� : ".$_SESSION['enseignant']->getCivilite()."<br>Nom : ".$_SESSION['enseignant']->getNom()."<br>Pr�nom : ".$_SESSION['enseignant']->getPrenom()."<br>T�l�phone : ".$_SESSION['enseignant']->getTel()."<br>
        Mail : ".$_SESSION['enseignant']->getMail()."<br>Classe : ".$classes."<br>El�ves : ".$_SESSION['nbrEleve']."<br>Accompagnateurs : ".$_SESSION['nbrAccom']."<br>
        <br><strong>Choix : </strong><br>
        Premier choix : ".$_SESSION['choix1']."<br>Deuxi�me choix : ".$_SESSION['choix2']."<br>Troisi�me choix : ".$_SESSION['choix3']."<br>
        <br>� tr�s bient�t.<br>
        L'�quipe du Kiosque.</body></html>";
            // ====
            // === Sujet mail
