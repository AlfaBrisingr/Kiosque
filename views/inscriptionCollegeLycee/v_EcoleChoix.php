...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1>Saison Spectacles Collèges/Lycées<?= $saisonCourante->getNom() ?></h1><br><br>
...
<?php if(isset($listEcole)) { ?>
    <form action="?uc=cl&action=etape1" method="POST">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table class="table table-hover table-stripped table-bordered table-condensed">
                    <legend><?php if(isset($_POST['typeEcole']) && $_POST['typeEcole'] == '3') { echo 'Collège'; } else { echo 'Lycée'; } ?></legend>
                    <thead>
                    <tr>
                        <th width="3%"></th>
                        <th width="20%">Nom</th>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <br><a href="?uc=cl&action=choisirTypeEcole">Retour</a>
                        </div>
                    </div>
                </div>
            </div>
