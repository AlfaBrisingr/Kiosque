<?php $jour = array('1' => 'Lundi','2' => 'Mardi','3' => 'Mercredi', '4' => 'Jeudi', '5' => 'Vendredi', '6' => 'Samedi', '7' => 'Dimanche'); ?>
	...
	<div class="container">
				...
				<div class="overflow-scroll-table">
					<table class="table table-hover table-condensed table-bordered">
						...
						<tr>
							...
							<td>
								<a href="?uc=admin&action=validerInscriptionCL&ins=<?= $inscription->getId()  ?>" title="Planifier l'inscription n° <?= $inscription->getId()  ?>">
									<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
								</a>
								<a href="?uc=admin&action=ModifierInscriptionCL&ins=<?= $inscription->getId()  ?>" title="Modifier l'inscription n° <?= $inscription->getId()  ?>">
									<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
								</a>
								<a onclick="return sure()" href="?uc=admin&action=SupprimerInscriptionCL&ins=<?= $inscription->getId()  ?>" title="Supprimer l'inscription n° <?= $inscription->getId()  ?>">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<legend>Planning <a title="Mettre le Tableau en PDF" href="?uc=admin&action=PlanningPDFCL"><span class="pull-right glyphicon glyphicon-new-window" aria-hidden="true"></span></a></legend>
				<div class="overflow-scroll-table">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9" id="jauge">
				<table class="table table-striped table-hover table-bordered table-condensed">
					<legend>Jauges<a title="Mettre le Tableau en PDF" href="?uc=admin&action=JaugePDFCL"><span class="pull-right glyphicon glyphicon-new-window" aria-hidden="true"></span></a></legend>
					<thead>
					<tr>
						<th>Séance</th>
						<th>Spectacle</th>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
				<legend>Séance <a title="Mettre le Tableau en PDF" href="?uc=admin&action=SeancePDFCL"><span class="pull-right glyphicon glyphicon-new-window" aria-hidden="true"></span></a> <a title="Ajouter une séance" href="?uc=admin&action=AjouterSeanceCL"><span class="pull-right glyphicon glyphicon-plus" aria-hidden="true"></span></a></legend>
				<div class="overflow-scroll-table">
					<table class="clear table table-striped table-hover table-condensed table-bordered">
						...
						<?php foreach ($listSean->getCollection() as $seance) { ?>
							<tr>
								...
								<td>
									<a onclick="return sure()" href="?uc=admin&action=SupprimerSeanceCL&seance=<?= $seance->getId() ?>">
										<span class="glyphicon glyphicon-remove"></span>
									</a>
								</td>
							</tr>
